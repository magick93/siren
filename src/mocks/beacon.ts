...
export const mockFormattedStates = [
  {"aggregated": 0, "attested": 0, "balance": 32, "index": 1, "missed": 0, "name": "VAL-1", "processed": 0, "pubKey": "mock-pubkey", "rewards": 0, "slashed": false, "status": "active_ongoing", "withdrawalAddress": "mock-creds"}]